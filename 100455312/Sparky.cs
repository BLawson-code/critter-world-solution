...
{
    public class Sparky : ICritterController
    {
        Point goal = new Point(-1, -1);
        System.Timers.Timer getInfoTimer;
        bool headingForGoal = true;
        ...
        {
            SparkySettings settings = new SparkySettings(this);
            settings.Show();
            settings.Focus();
        }
            ...
            foreach (string thing in whatISee)
            {
                ...
                else
                {
                    ...
                    switch (thingAttributes[0])
                    {
                        ...
                        case "Bomb":
                            if (SparkySettings._BoxCheck == true);
                            {
        ...
        private void SetDestination(Point goAroundBomb, object speed)
        {
            throw new NotImplementedException();
        }

        private int CirclePoint(int v1, int v2, int x)
        {
            throw new NotImplementedException();
        }
